...
{?>
                                        ...
                                        <p><?php echo htmlentities($num1);?> Complaints not Process yet</p> <?php }?>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
...
{?>
                                        ...
                                        <p><?php echo htmlentities($num1);?> Complaints Status in process</p> <?php }?>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
...
{?>
                                        ...
                                        <p><?php echo htmlentities($num1);?> Complaint has been closed</p> <?php }?>
                                    </div>
                                </div>
                            </div>
                        </div>
