...
CREATE TABLE `tblcomplaints` (
  `id` int(11) NOT NULL,
  `ticketCreateUser` int(11) NOT NULL,
  ...
  `lastUpdationDate` datetime DEFAULT NULL ON UPDATE current_timestamp(),
...
--
-- Table structure for table `tblcomplaints_old`
--

CREATE TABLE `tblcomplaints_old` (
  `complaintNumber` int(11) NOT NULL,
...
--
-- Indexes for table `tblcomplaints_old`
--
ALTER TABLE `tblcomplaints_old`
...
--
-- AUTO_INCREMENT for table `tblcomplaints_old`
--
ALTER TABLE `tblcomplaints_old`
